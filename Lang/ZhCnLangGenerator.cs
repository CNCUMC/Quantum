...
public class ZhCnLangGenerator : ModLangGenBase
{
    ...
    protected override void BuildLocaleData()
    {
        ...
        Option("quantum.input.debug_screen", "调试屏幕", "显示调试信息");
        Option("quantum.input.debug_screen_fps_graph", "调试屏幕 FPS 图标", "在调试屏幕中显示帧生成时间图表");
        Option("quantum.input.hidden_hud", "隐藏 HUD", "隐藏所有 HUD");
